    ...
    private function getSolutionsData(): array
    {
        return [
            ...
            'medtrace' => [
                ...
                'summary' => 'Secure digital medical record access for healthcare teams that need critical patient information at the point of care.',
                ...
                'features' => [
                    'Secure QR-based access to critical patient records',
                    'Role-based visibility for authorized healthcare staff',
                    'Emergency information including allergies and blood type',
                    'Portable medical identity for faster care decisions',
                ],
                'workflow' => [
                    'A patient profile is created and linked to a secure QR identity.',
                    'Authorized staff scan the QR code at the point of care.',
                    'Critical information is displayed quickly for safer decisions.',
                ],
            ],
        ];
    }
