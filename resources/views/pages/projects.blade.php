            ...
            <div class="inner-banner-content">
                <div class="inner-banner-text-wrapper">
                    <div class="inner-banner-typography">
                        <h1 class="inner-banner-title">Our Portfolios</h1>
                        <p class="inner-banner-description">Explore our collection of successful projects, showcasing our
                            commitment to quality, innovation, and immersive experiences.</p>
                    </div>
